...
#define MEMSIZE 1024*1024*50 // Size of Ram disk bytes (50mib)
...
#define PARTITION_TABLE_SIZE sizeof(PartTable)
...
static PartTable def_part_table =
        {
                ...
                },
                {
                        ...
                        .sec_in_part =  MIB_TO_SECTORS(25) - 1
                },
                {
                        .boot_type =  0x0,
                        .start_sec =  0x2,
                        ...
                        .end_sec =  0x0,
                        .end_cyl =  0x0,
                        .abs_start_sec =  MIB_TO_SECTORS(35),
                        .sec_in_part =  MIB_TO_SECTORS(15) - 1
                }
        };
...
// functions
        ...
        {
            dev->capacity = MEMSIZE / SECTOR_SIZE;
            dev->data = vmalloc(MEMSIZE); //
            if (dev->data == NULL) {
...
//
        static int sblkdev_add_device(void)
        {
            ...
            do {
                ...
                {// configure disk
                    struct gendisk *disk = alloc_disk(8); //only one partition
                    if (disk == NULL) {
